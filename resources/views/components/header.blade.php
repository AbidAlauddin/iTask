<header class="fixed top-0 left-0 right-0 flex items-center justify-between bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 pl-64 pr-10 h-20 z-50" x-data="{ profileMenuOpen: false }" @toggle-sidebar.window="$dispatch('toggle-sidebar')">
    <div class="flex items-center space-x-4 h-full w-full">
        ...
        <div class="relative h-full flex items-center">
            <input type="text" placeholder="Search..." class="pl-10 pr-4 py-2 rounded-md text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 h-10" />
...
=======
<div x-data="darkMode" @click="toggleTheme()" class="flex items-center cursor-pointer" x-bind:class="{ 'dark': html.classList.contains('dark') }">
...
>>>>>>> f2b65e394a6175add6d10da27fb9e970a0b2ba3d
